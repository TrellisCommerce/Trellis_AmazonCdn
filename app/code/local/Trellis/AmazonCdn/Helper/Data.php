...
class Trellis_AmazonCdn_Helper_Data extends Mage_Core_Helper_Abstract
{
    /**@+
     * Config paths to retrieve Trellis_AmazonCdn settings
     *
     * @var string
     */
    const XPATH_CONFIG_IS_ENABLED        = 'trellis_amazoncdn/general/is_enabled';
    const XPATH_CONFIG_CACHE_CHECK_SIZE  = 'trellis_amazoncdn/general/cache_check_size';
    const XPATH_CONFIG_CACHE_TTL         = 'trellis_amazoncdn/general/cache_ttl';
    const XPATH_CONFIG_COMPRESSION       = 'trellis_amazoncdn/general/compression';
    const XPATH_CONFIG_DEBUG_MODE        = 'trellis_amazoncdn/general/debug_mode';
    const XPATH_CONFIG_BUCKET_NAME       = 'trellis_amazoncdn/amazons3/bucket';
    const XPATH_CONFIG_ACCESS_KEY_ID     = 'trellis_amazoncdn/amazons3/access_key_id';
    const XPATH_CONFIG_SECRET_ACCESS_KEY = 'trellis_amazoncdn/amazons3/secret_access_key';
    /**@-*/
     ...
     * Logger instance
     *
     * @var Trellis_AmazonCdn_Helper_Logger
     */
    protected $_logger;
     ...
     *
     * @var Trellis_AmazonCdn_Model_Cdn_Adapter
     */
     ...
     *
     * @var Trellis_AmazonCdn_Model_Cache_Facade
     */
     ...
     * Get logger
     *
     * @return Trellis_AmazonCdn_Helper_Logger
     */
    public function getLogger()
    {
        if ($this->_logger === null) {
            $debugMode     = Mage::getStoreConfigFlag(self::XPATH_CONFIG_DEBUG_MODE);
            $this->_logger = new Trellis_AmazonCdn_Helper_Logger($debugMode);
        }
     ...
     * Get cache facade instance
     *
     * @return Trellis_AmazonCdn_Model_Cache_Facade
     */
    public function getCacheFacade()
    {
        if ($this->_cacheFacade === null) {
            $cdnAdapter = $this->getCdnAdapter();
            /** @var Trellis_AmazonCdn_Model_Cache $cacheModel */
            $cacheModel = Mage::getSingleton('trellis_amazoncdn/cache');
            $verifySize = Mage::getStoreConfigFlag(self::XPATH_CONFIG_CACHE_CHECK_SIZE);
            $ttl        = Mage::getStoreConfig(self::XPATH_CONFIG_CACHE_TTL);
            $this->_cacheFacade = new Trellis_AmazonCdn_Model_Cache_Facade($cdnAdapter, $cacheModel, $verifySize, $ttl);
        }
     ...
     *
     * @return Trellis_AmazonCdn_Model_Cdn_Adapter
     */
    public function getCdnAdapter()
    {
        if ($this->_cdnAdapter === null) {
            ...
            $this->_cdnAdapter = new Trellis_AmazonCdn_Model_Cdn_Adapter($bucket, $accessKeyId, $secretAccessKey);
        }
