...
class Trellis_AmazonCdn_Model_Cache_Facade
{
    /**
    ...
    /**
     * @var Trellis_AmazonCdn_Model_Cache
     */
     ...
     * Class constructor
     *
     * @param Trellis_AmazonCdn_Model_Cdn_Adapter $adapter
     * @param Trellis_AmazonCdn_Model_Cache $cacheModel
     * @param bool $verifySize
     * @param float $cacheTtl
     */
    public function __construct(Trellis_AmazonCdn_Model_Cdn_Adapter $adapter, Trellis_AmazonCdn_Model_Cache $cacheModel,
        $verifySize, $cacheTtl
    ) {
