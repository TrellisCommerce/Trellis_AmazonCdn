...
class Trellis_AmazonCdn_Model_Cdn_Adapter
{
    /**@+
     ...
     * Connection handle
     *
     * @var Trellis_AmazonCdn_Model_Cdn_Connector
     */
     ...
     *
     * @return Trellis_AmazonCdn_Model_Cdn_Connector
     */
    protected function _getConnector()
    {
        if ($this->_connector === null) {
            $error     = false;
            $connector = new Trellis_AmazonCdn_Model_Cdn_Connector($this->_accessKeyId, $this->_secretAccessKey);
