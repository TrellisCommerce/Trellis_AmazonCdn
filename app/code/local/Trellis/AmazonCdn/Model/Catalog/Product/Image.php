...
class Trellis_AmazonCdn_Model_Catalog_Product_Image extends Mage_Catalog_Model_Product_Image
{
    /**
     * Get helper
     *
     ...
     *
     * @return Trellis_AmazonCdn_Model_Varien_Image
     */
    public function getImageProcessor()
    {
        if (!$this->_processor) {
            if ($this->_getHelper()->isConfigured()) {
                $this->_processor = Mage::getModel('trellis_amazoncdn/varien_image', $this->getBaseFile());
            }
        }
